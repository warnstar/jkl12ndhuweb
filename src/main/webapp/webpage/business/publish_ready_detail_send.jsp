...
<div class="l_right ">
    ...
    <div class="l_moban"><!-- 模板 style -->
        ...
        <div class="h_content_mian l_all">
            ...
            <div class="h_mian_bt  l_all">商品信息<span class="status">商品状态：<b>已发货</b></span></div>
                ...
                <c:if test="${coupon != null}">
                        ...
                        <div class="h_usered">
                            <ul>
                                ...
                                <li class="tan1 showwiners" value="${listwiner.id }">
                                    <p class="bold">第${listwiner.goods_current_num }期购买单号：<b>${listwiner.lucky_id }</b></p>
                                    <p>手机号：<b>${listwiner.mobile}</b></p>
                                    <p>用户晒单：<b>
                                        <c:choose>
                        ...
                        <div class="luky_number">
                            ...
                            <b> <c:choose>
                                <c:when test="${detail.shareNum}==${detail.goodsNum}">
                                    已完成
                                </c:when>
                                <c:otherwise>
                                    未返还
                                </c:otherwise>
                            </c:choose> </b> <b>已晒单数量：${detail.shareNum}/${detail.goodsNum}</b><!-- 或者已返还 -->
...
/* 调用弹框*/
 ...
 $('.showwiners').bind("click",function() {
		...
		$.post(
				url='<%=basePath%>/storeSingleBusiness.do?publish_show_winers',
				data={
						id : id 
						},
				function(result){

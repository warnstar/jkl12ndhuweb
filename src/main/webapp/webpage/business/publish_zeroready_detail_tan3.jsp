...
%>
  <div class="theme-poptit">
        ...
        <h3 class="fl">商品信息<span class="status fr">商品状态：<b>未发货</b></span><span class="status fr">商品期数：<b>${listdetail1.zserial_num}-${number}</b></span></h3>
...
<c:if test="${coupon != null}">
        ...
        <h2 class="coupon_inf">中奖用户资料</h2>
         <c:forEach items="${userlist}" var="userlist">
        <div class="h_shop_information">
            <span class="shop_img dk fl" style="width:150px;height:150px;"><img src="${userlist.headImg }" alt=""></span>
            ...
            <div class="shop_inf fl" style="width:400px;">
                ...
                <p>
                    <span class="inf_title fl">幸运号码：</span>
                    <span class="inf_detail fl">${userlist.lucky_id }</span>
                </p>
                <p>
...
<!-- 弹窗内容模块 结束-->
    ...
    <script>
	 ...
	 $.post(
				url='<%=basePath%>/zeroSingleBusiness.do?make_zerosure_send',
				data={
						id : id 
						},
				function(result){

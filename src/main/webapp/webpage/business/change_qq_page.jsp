            ...
            <div class=" h_content_all l_all dongtai" style="border:none;">
                <div class="h_register_all" style="margin-top:40px;">
                    <div class="register_all">
                        <ul>
                            <li class="title">修改QQ号码</li>
                            <li></li>
                            <li><input type="text" id="business_qq" class="re_input" placeholder="请输入QQ号码:${qq }" maxlength="12"></li>
                            <li class="btns">
...
$("#saveParameter").bind('click',function(){
	var business_qq=$("#business_qq").val();
	if(business_qq==""){alert("不能为空！");return;}
	var name="";
	var shopname="";
	$.post(

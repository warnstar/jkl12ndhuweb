                ...
                <div class="h_register_all" style="margin-top:40px;">
                    <div class="register_all">
                        <ul>
                            ...
                            <li>旧密码</li>
                            <li><input type="password" id="oldpwd" class="re_input" ></li>

                            <li>新密码</li>
                            <li><input type="password" id="newpwd" class="re_input" maxlength="20"></li>

                            <li>重复密码</li>
                            <li><input type="password" id="new2pwd"  class="re_input" maxlength="20"></li>
                            <li class="btns">
                                <input type="submit" value="提交" id="chong" class="h_submit fl">
...
$(".returnto").bind('click',function(){
	$.post(
			url="<%=basePath%>/storeBusiness.do?change_pwd_page",
			 data={ },
			 function(result){
				 $('body').empty().html(result);
			 },'text')
})
 $("#chong").bind('click',function(){
	var old=$("#oldpwd").val();
	if(old==""){alert("不能为空！");return;}
	var n1=$("#newpwd").val();
	if(n1==""){alert("不能为空！");return;}
	var n2=$("#new2pwd").val();
	if(n2==""){alert("不能为空！");return;}
	if(n1==n2){
				$.post(

						url="<%=basePath%>/storeBusiness.do?change_pwd",
						data={
							  old : old,
							  newone : n1
							  },

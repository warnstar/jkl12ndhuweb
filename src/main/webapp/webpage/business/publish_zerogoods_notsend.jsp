...
<div class="l_right ">
    ...
    <div class="l_moban"><!-- 模板 style -->
        ...
        <div id="qwertyui" style="padding: 0 20px 0 20px;">
                ...
                <div class=" h_content_all l_all dongtai pagen" value="${pagenow}">
                     <c:forEach items="${notsendList}" var="notsendlist">     
                        <ul class="h_contents l_all ">
                            ...
                            <li class="w15">第${notsendlist.zserial_num}-${notsendlist.goods_current_num }期</li>
...
/* 调用弹框*/
 ...
 $(".tcdPageCode").createPage({
     ...
     backFn:function(p){
      ...
      $.post(
 				url='<%=basePath%>/zeroSingleBusiness.do?publish_zerogoods_notsend',
				data={
						pagenow : p,
						search : type,
						name : name
 ...
 $('body').on('click','.tan3',function(event) {
		...
		$.post(
				url='<%=basePath%>/zeroSingleBusiness.do?publish_zeroready_detailnotsend',
				data={
						id : id 
						},
				function(result){

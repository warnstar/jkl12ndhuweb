            ...
            <div class=" h_content_all l_all dongtai pagen" value="${pagenow}">
                 <c:forEach items="${goodslist}" var="listgoodslist">   
                    <ul class="h_contents l_all ">
                        ...
                        <li class="w15">第${listgoodslist.serial_num}-${listgoodslist.goods_current_num}期</li>
                        <li class="w15">${listgoodslist.goods_name}</li> 
                        <li class="w10">${listgoodslist.goods_rmb}</li>
                        <li class="w10">${ listgoodslist.goods_current_num}/${listgoodslist.goods_num}</li>
...
/* 调用弹框*/
 ...
 $(".searchwhy").bind('click',function(){
		...
		$.post(
				url='<%=basePath%>/storeSingleBusiness.do?publish_goods_notopen',
				data={
						search : search,
						pagenow : 1
						},

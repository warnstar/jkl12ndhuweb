...
%>
 <div class="theme-poptit">
 	 <c:forEach items="${detail}" var="listdetail1">
        <h3 class="fl">商品信息<span class="status fr">商品状态：<b>未售出</b></span><span class="status fr">商品期数：<b>${listdetail1.serial_num}-${listdetail1.goods_current_num}</b></span></h3>
       ...
       <%-- <h2 class="coupon_inf" style="margin:0 0 10px 0;">商品夺宝进度</h2>
        <div class="h_schedule">
            ...
            <div class="schedule_nums">
                ...
                <span class="fl">总需<b id="all_num">${detaillist.goods_rmb }</b>人次</span>
                <span class="fr">剩余<b id="remainder">${detaillist.goods_rmb-detaillist.current_join_num }</b></span>
                </c:forEach>
            </div>
        </div>
        <script>

...
<div class="l_right ">
    ...
    <div class="l_moban"><!-- 模板 style -->
        ...
        <div class="h_content_mian l_all">
            ...
            <div class="h_mian_bt  l_all">未售出商品列表</div>
            ...
            <div class="h_mian_nav l_all dongtai">
                ...
                <ul>
                    ...
                    <li class="w10">购买人数</li>
                    <li class="w25">操作</li>
                </ul>
            </div><!-- h_mian_nav -->
			
            <div class=" h_content_all l_all dongtai pagen" value="${pagenow}">
                 <c:forEach items="${goodslist}" var="listgoodslist">   
                    <ul class="h_contents l_all ">
                        <li class="w15">${listgoodslist.create_time}</li>
                        <li class="w15">第${listgoodslist.zserial_num}-${listgoodslist.goods_current_num}期</li>
                        <li class="w15">${listgoodslist.zgoods_name}</li> 
                        <li class="w10">${listgoodslist.zgoods_rmb}</li>
                        <li class="w10">${ listgoodslist.goods_current_num}/${listgoodslist.zgoods_num}</li>
                        <li class="w10">${ listgoodslist.current_join_num}</li>                        
                        <li class="w25 ">
                            <a href="javascript:;" class="h_mx dk fl bianji tan2 " style="color:#fff !important;width:74px;" value="${listgoodslist.id }">查看详情</a>                      
                        </li>
                    </ul>
				</c:forEach>               
            </div><!-- h_mian_nav -->
...
/* 调用弹框*/
 ...
 $('body').on('click','.tan2',function(event) {
	 var id=$(this).attr("value");
		$.post(
				url='<%=basePath%>/zeroSingleBusiness.do?publish_zeroready_detailnotopen',
				data={
						id : id 
						},
				function(result){
 ...
 $(".searchtype").bind('click',function(){
		...
		var name=$("#search").val();
		$.post(
				url='<%=basePath%>/zeroSingleBusiness.do?publish_zerogoods_notopen',
				data={
						search: search,
						pagenow : 1,
						name : name

...
<div class="h_content_mian l_all">
            ...
            <div class="h_mian_nav l_all dongtai pagen" value="${pagenow }">
            ...
            <div class=" h_content_all l_all dongtai" >
                    <c:forEach items="${goodslist}" var="list">
                    <ul class="h_contents l_all ">
                        <li class="w20">${list.create_time}</li>
                        <li class="w20">${list.goods_name}</li>
                        <li class="w10">${list.goods_rmb}</li> 
                        <li class="w15">${list.goods_num}</li>
                         <c:choose>
 ...
 $(".tcdPageCode").createPage({
     ...
     backFn:function(p){
    	 var typel=$(".showtype").val();
 		 ...
 		 $.post(
 				url='<%=basePath%>/storeBusiness.do?publish_not_ready_list',
 				data={
 						pagenow : p,
 						typel : typel,
 						whyl : whyl,
 ...
 $(".publish_not_ready_detail3").bind('click',function(){
	 ...
	 $.post(
				url='<%=basePath%>/storeBusiness.do?publish_not_ready_detail',
				data={id: id},
				function(result){

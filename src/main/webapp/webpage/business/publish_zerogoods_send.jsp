...
<div class="l_right ">
    ...
    <div class="l_moban"><!-- 模板 style -->
        ...
        <div id="qwertyui" style="padding:0px 20px 0 20px;">
               ...
               <div class="h_mian_nav l_all dongtai">
                 ...
                 <!--    <ul>
                    ...
                    <ul>
                        ...
                        <li class="w15">商品名称</li> 
                        <li class="w10">商品单价（元）</li>
                        <li class="w10">已售出数量</li>
                        <li class="w15">已晒单数量</li>                                          
                        <li class="w25">操作</li>
                    </ul>
                </div><!-- h_mian_nav -->

                <div class="jueduibiankuang h_content_all l_all dongtai pagen" value="${pagenow}">
                     <c:forEach items="${sendList}" var="notsendlist">     
                        <ul class="h_contents l_all ">
                            <li class="w15">${notsendlist.create_time}</li>
                           
                            <li class="w15">${notsendlist.zgoods_name}</li> 
                            <li class="w10">${notsendlist.zgoods_rmb }</li>
                            <li class="w10">${notsendlist.goods_current_num }/${notsendlist.zgoods_num }</li>
                            <li class="w15">第${notsendlist.zshare_num}-${notsendlist.zgoods_num}期</li>
                         <!--    <li class="w10">58</li>   -->                      
                            <li class="w25 ">
...
/* 调用弹框*/
 ...
 $(".tcdPageCode").createPage({
     ...
     backFn:function(p){
      ...
      $.post(
 				url='<%=basePath%>/zeroSingleBusiness.do?publish_zerogoods_send',
				data={
						pagenow : p,
						search : type,
						name : name
 ...
 $('body').on('click','.tan3',function(event) {
		...
		$.post(
				url='<%=basePath%>/zeroSingleBusiness.do?publish_zeroready_detailsend',
				data={
						id : id 
						},
				function(result){

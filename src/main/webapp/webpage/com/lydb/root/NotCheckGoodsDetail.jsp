...
<div class="theme-popover theme2" style="display:block;"><!-- 点击按钮，调用theme2事件， -->
     <div class="theme-poptit">
        <h1 class="fl" style="font-size:32px;">商品信息<span class="status fr">商品状态：<b>
        <c:choose>
    ...
    <!-- 弹窗内容模块 开始-->
    <div class="popbod" >
        <div class="h_shop_information" style="height:490px;">
                <div style="width: 100%;height:auto;">
                    <span class="shop_img dk fl"><a href="${goods.goodsHeadurl}" target="_blank"><img src="${goods.goodsHeadurl}" alt=""  onload="test(this)"/></a></span>

...
<div class="theme-popover theme2"style="display:block;width:100%;" ><!-- 点击按钮，调用theme2事件， -->
    <div class="theme-poptit">
        <h3 class="fl">商品信息<span class="status fr">商品状态：<b>
        <c:choose>
    ...
    </c:choose></b></span><span class="status fr">商品序列号：<b>${goods.serialNum}</b></span></h3>
    </div>
    ...
    <div class="popbod" >
                        ...
                        <div class="h_shop_information">
                            <span class="shop_img dk fl"><a href="${goods.goodsHeadurl}" target="_blank"> <img href="${goods.goodsHeadurl}" src="${goods.goodsHeadurl}" alt=""></a></span>
                   ...
                   <div class="luky_number"style="height: 60px;">
                        ...
                        </b>（已晒单数量：${goods.shareNum}/${goods.goodsNum}）</span>

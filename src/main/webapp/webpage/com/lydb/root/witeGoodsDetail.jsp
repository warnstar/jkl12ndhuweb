...
<div class="theme-popover theme2" style="display:block;"><!-- 点击按钮，调用theme2事件， -->
     <div class="theme-poptit">
        <h1 class="fl" style="font-size:32px;">商品信息<span class="status fr">商品状态：<b>等待缴费</b></span></h1>
    </div>

    <!-- 弹窗内容模块 开始-->
    <div class="popbod" >
        <div class="h_shop_information">
            <span class="shop_img dk fl"><img src="${goods.goodsHeadurl}" alt=""></span>
            <div class="shop_inf fl">
                ...
                <p>
                    ...
                    <span class="inf_detail fl">${goods.goodsNum}</span>
                </p>
               <%-- <p>
       ...
       <div class="h_shop_information" style="height:150px;">
        ...
        <div class="luky_number" style="height: 45px">
         ...
         <h2 class="coupon_inf" style="margin:0 0 10px 0;"> 可得金额（元）</h2>

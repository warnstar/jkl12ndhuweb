...
<div class="theme-popover theme2"style="display:block;" ><!-- 点击按钮，调用theme2事件， -->
    <div class="theme-poptit">
        <h3 class="fl">0元商品信息<span class="status fr">商品状态：<b>未开奖</b></span><span class="status fr">商品序列号：<b>${goods.zserialNum}</b></span></h3>
    </div>
    ...
    <div class="popbod" >
       ...
       <h2 class="coupon_inf" style="margin:0 0 10px 0;">开奖时间</h2>
        <div class="luky_number">
             	开奖时间：<b>${single.openTime}</b>
        </div>

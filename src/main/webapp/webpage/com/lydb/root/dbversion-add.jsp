...
<body>
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="dbversionController.do?doAdd"
             tiptype="1">
    ...
    <table style="width: 700px;" cellpadding="0" cellspacing="1" class="formtable">
        ...
        <tr>
            ...
            <td class="value">
                <textarea id="content" name="content" style="width:400px;height:260px;"  datatype="*" errormsg="内容不能为空！"></textarea>
                <span class="Validform_checktip"></span>
...
<script src="webpage/com/lydb/dbversion/dbversion.js"></script>
...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="IsPrizeGoods" fitColumns="false" title="已开奖零元商品列表" actionUrl="BusManagement.do?Zerogoodsdatagrid&dbWebBusinessid=${id}&type=6"  pageSize="50" idField="id" fit="true" queryMode="group" >
   ...
   <t:dgCol title="商品开奖时间"  field="open_time"  formatter="yyyy-MM-dd hh:mm:ss"  align="center"   ></t:dgCol>
    ...
    <t:dgCol title="商品状态"  field="status" replace="已开奖未发货_2,已开奖已发货_3,已开奖已收货_4" align="center"  query="true" ></t:dgCol>
...
<script src="<%=basePath %>/webpage/js/myJacaScript.js"></script>
 ...
 function LookGoodsDeteil(id){
	 $.dialog({
			content: "url:BusManagement.do?BusinessZeroGoodsByType&zGoodsID="+id+"&Type=6",
			inline:true,
			lock : true,
			title:'零元商品',
			opacity : 0.3,

...
<body>
    ...
    <div id="login">
        ...
        <div class="inner">
            <div class="logo" style="font-size:60px;font-weight: bold;letter-spacing: 2px;"> 一圆梦 </div>
            <div class="formLogin">
                <form name="formLogin" id="formLogin" action="loginController.do?login" check="loginController.do?checkuser" method="post">
                    <input name="userKey" type="hidden" id="userKey" value="" />
                    <div class="tip">
                    	
                       <input class="account1" id="userName" name="userName" onfocus="if (value =='输入账号'){placeholder =''}" placeholder="输入账号" iscookie="true" type="text" value="">
                    </div>
                   
                 
                    <div class="tip">
                  		 
                  		 <input class="account2 " id="password" name="password" onblur="if (placeholder ==''){placeholder='输入账号'}" onfocus="if (value =='请输入密码'){placeholder =''}" placeholder="请输入密码" type="password">
                  		 
                    </div>
                    <div >
                        <div style="float: right; margin-left:-150px; margin-right: 10px;">
                            <img id="randCodeImage" src="randCodeImage" />
                        </div>
                        
                        <input class="account3" name="randCode" type="text" id="randCode" onfocus="if (value =='输入验证码'){placeholder =''}" placeholder="输入验证码"  title="" value="" nullmsg="" />
                    </div>

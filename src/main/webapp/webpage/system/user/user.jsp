	...
	<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value" width="85%">
                ...
                <c:if test="${user.id==null }">
                    <input id="userName" class="inputxt" name="userName" maxlength="10" validType="t_s_base_user,userName,id" value="${user.userName }" datatype="s2-10" />
		...
		<tr>
			...
			<td class="value" width="10%">
                <input id="realName" class="inputxt" name="realName" maxlength="10" value="${user.realName }" datatype="s2-10">
		...
		<c:if test="${user.id==null }">
			<tr>
				...
				<td class="value">
                    <input type="password" class="inputxt" value="" maxlength="18" name="password" plugin="passwordStrength" datatype="*6-18" errormsg="" />
			...
			<tr>
				...
				<td class="value">
                    <input id="repassword" class="inputxt" type="password" value="${user.password}" maxlength="18" recheck="password" datatype="*6-18" errormsg="两次输入的密码不一致！">
		...
		<tr>
			...
			<td class="value" nowrap>
                ...
                <t:choose hiddenName="roleid" hiddenid="id" url="userController.do?roles" name="roleList"
                          icon="icon-search" title="common.role.list" textname="roleName" isclear="true" isInit="true" width="600px" height="500px" left="50%" top="30%"></t:choose>
		...
		<tr>
			...
			<td class="value">
                <input class="inputxt" name="mobilePhone" value="${user.mobilePhone}" maxlength="11" datatype="m" errormsg="手机号码不正确" ignore="ignore">
		...
		<tr>
			...
			<td class="value">
                <input class="inputxt" name="officePhone" value="${user.officePhone}" maxlength="15" datatype="n" errormsg="办公室电话不正确" ignore="ignore">
                <span class="Validform_checktip"></span>
            </td>
		</tr>
		<tr>
			...
			<td class="value">
                <input class="inputxt" name="email" value="${user.email}" datatype="e" maxlength="25" errormsg="邮箱格式不正确!" ignore="ignore">
                <span class="Validform_checktip"></span>
            </td>
		</tr>
	</table>

...
public class DemoController extends BaseController {
	...
	@RequestMapping(params = "huiyuan")
	public ModelAndView huiyuan(HttpServletRequest request) {
		return new ModelAndView("ceshi/huiyuan");
	}
	/**
	 * 登录检测并返回消息
	 */
	...
	@ResponseBody
	public AjaxJson logincheck(String account,String password,HttpServletRequest request) {

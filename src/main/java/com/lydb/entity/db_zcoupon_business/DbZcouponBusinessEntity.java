package com.lydb.entity.db_zcoupon_business;
...
/**   
 * @Title: Entity
 * @Description: 0元夺宝优惠券表
 * @author onlineGenerator
 * @date 2015-11-25 10:29:48
 * @version V1.0   
 *
 */
@Entity
@Table(name = "db_zcoupon_business", schema = "")
@SuppressWarnings("serial")
public class DbZcouponBusinessEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 *@return: java.lang.Integer  优惠卷面值
	 */
	 ...
	 */
	@Column(name ="COUPON_URL",nullable=false,length=150)

...
public class OrderForAndriod {
	...
	public static String ReqData(String appid, int waresid,String waresname,String cporderid ,float price,String appuserid,String cpprivateinfo,String notifyurl) {
		...
		String json;
		json = "appid:";
		json += IAppPaySDKConfi_ForAndriod.APP_ID;
		json += " userid:";
		json += appuserid;
		json += " waresid:";
		json += waresid;
		...
		jsonObject.put("appid", IAppPaySDKConfi_ForAndriod.APP_ID);
		jsonObject.put("waresid", IAppPaySDKConfi_ForAndriod.WARES_ID_1);
		...
		String sign = SignHelper.sign(content, IAppPaySDKConfi_ForAndriod.APPV_KEY);
	...
	public static String CheckSign(String appid, int waresid,String waresname,String cporderid,float price,String appuserid,String cpprivateinfo,String notifyurl) {
		String reqData = ReqData( IAppPaySDKConfi_ForAndriod.APP_ID,  IAppPaySDKConfi_ForAndriod.WARES_ID_1, waresname,cporderid, price, appuserid, cpprivateinfo, notifyurl);
	...
	if(signtype==null)
	{
		 ...
		 */
		if (SignHelper.verify(reslutMap.get("transdata"), reslutMap.get("sign"),IAppPaySDKConfi_ForAndriod.PLATP_KEY)) {
	...
	public static String H5orPCpay(String transid){
		...
		jsonObject.put("redirecturl", "http://120.25.145.15/xingluo/storeLoginBusiness.do?index");
...
//CheckSign(             String appid,          int waresid,                  String waresname,   String cporderid, float prce,     String appuserid,        String cpprivateinfo,       String notifyurl)
		CheckSign( IAppPaySDKConfi_ForAndriod.APP_ID,IAppPaySDKConfi_ForAndriod.WARES_ID_1,"aaa", "123123",0.1f, "108412312312310", "1231231231", "http://58.250.160.241:8888/IapppayCpSyncForPHPDemo/TradingResultsNotice.php");
		H5orPCpay(transid);
	}
